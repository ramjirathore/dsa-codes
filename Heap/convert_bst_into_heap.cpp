...
// CODE - (From GFG) - O(n) time and O(n) space

// The solution is pretty simple find inorder of BST
// Thus we will get nodes in sorted order 
// Then using preorder traversal replace all the values in the tree by the inorder array
